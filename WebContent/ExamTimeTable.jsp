			...
			<div class="boader2"
				...
				<div class="boader3"
					...
					<div class="boader4"
						...
						<div class="formMain">
							<p
								style="position: relative; top: 23px; left: 39%; font-size: 28px; padding: 0px; margin: 0px; color: #232f3e; font-family: 'Roboto Condensed', sans-serif;">ExamTimeTable for Student</p>
							<form action="studentDisplayExamtimeTableServlet" style="width: 80%;" method="post">
								<div class="container"
									style="position: relative; left: 203px; top: 27px;">
									<img src="Pictures/male-university-graduate-silhouette-with-the-cap.svg"
										style="position: absolute; top: 31px; width: 114px; left: -119px;">
									<input type="text" placeholder="Enter Student ID" name="sid" required> 
									
									<button type="submit"
										style="margin-left: 81px; width: 112px; border-radius: 5px; font-size: 20px;">View</button>
								</div>
							</form>
						</div>
					</div>
			...
			<div class="boader2"
				...
				<div class="boader3"
					...
					<div class="boader4"
						...
						<div class="formMain">
							<p
								style="position: relative; top: 23px; left: 39%; font-size: 28px; padding: 0px; margin: 0px; color: #232f3e; font-family: 'Roboto Condensed', sans-serif;">ExamTimeTable for Teacher</p>
							<form action="teacherDisplayExamtimeTableServlet" style="width: 80%;" method="post">
								<div class="container"
									style="position: relative; left: 203px; top: 27px;">
									<img src="Pictures/class.svg"
										style="position: absolute; top: 31px; width: 114px; left: -119px;">
