...
<body>
    ...
    <div class="formWrapper">
        <form method="post" action="AdminEnterTeacher">
            <p>Teacher's Data</p>
            <input type="text" name="id" placeholder="Enter Teacher's ID" required id="input1">
            <input type="text" name="nid" placeholder="Enter Teacher's Natinal ID" required id="input1">
            <input type="text" name="fname" placeholder="Enter Teacher's First Name" id="input1">
            <input type="text" name="lname" placeholder="Enter Teacher's Last name" id="input1">
            <input type="text" name="position" placeholder="Enter Teacher's Position" id="input1">
            <input type="text" name=""dob placeholder="Enter Teacher's DOB" id="input1">
            <input type="number" name="mno" placeholder="Enter Teacher's Mobile No" id="input1">
            <p style="    display: inline;
    top: 7px;
    left: 55px;     font-size: 16px;">Gender</p>
            <div class="genders">
                <input type="radio" name="gender" value="male"> Male <br>
                <input type="radio" name="gender" value="Female"> Female <br>
            </div>
            <input type="text" name="address" placeholder="Enter Teacher's Address" id="input1">
            <div class="buttons">
                <input type="submit" name="save" value="save" class="buutonss" style="    padding-left: 29px;
    padding-right: 29px;">
