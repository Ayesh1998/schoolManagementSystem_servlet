...
<%@ page import="com.servletProject_Y2S1_Student.*"%>
<!DOCTYPE html>
<html>
<head>
...
<body>
	...
	<%
		ArrayList table1 = (ArrayList) request.getAttribute("table");
	%>
	...
	<tbody>
	 ...
	 <%
 	for (int counte = 0; counte < table1.size(); counte++) { %>
 	
	<tr>
	
		<%
			TimeTables t1 = (TimeTables) table1.get(counte);
		%>
	...
	<div class="footer" style="position: relative; top: 3em;;">
