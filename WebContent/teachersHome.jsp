    ...
    <div class="list">
        <div class="column">
            <div class="card">
                ...
                <div class="container">
                    <h2 id="lableName">Enter Student Marks</h2>
                     <form action="teacherEnterMarks.jsp" method="post">
            ...
            <div class="card">
                ...
                <div class="container">
                    <h2 id="lableName">Timetable</h2>
                    
                    <form action="TeacherDisplayTimetableServlet" method="post">
...
">
                <div class="container">
                   ...
                   <form action="TeacherShowProfileServlet" method="post">
