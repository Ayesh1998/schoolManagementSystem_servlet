			...
			<div class="boader2"
				...
				<div class="boader3"
					...
					<div class="boader4"
						...
						<div class="formMain">
							<p
								style="position: relative; top: 23px; left: 39%; font-size: 28px; padding: 0px; margin: 0px; color: #232f3e; font-family: 'Roboto Condensed', sans-serif;">Teacher
								Login</p>
							<form action="logTeacher" style="width: 80%;" method="post">
								<div class="container"
