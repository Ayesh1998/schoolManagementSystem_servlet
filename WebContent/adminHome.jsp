...
<body>
    ...
    <div class="list">
        <div class="column">
            <div class="card">
                <img src="Pictures/male-university-graduate-silhouette-with-the-cap.svg" alt="Student" style="width:100%">
                <div class="container">
                    <h2 id="lableName">Student</h2>
                    <P><button class="button"><a href="adminEnterStudentsData.jsp">Enter</a></button></p>
                </div>
            </div>
        </div><div class="column">
            <div class="card">
                <img src="Pictures/class.svg" alt="Teacher" style="width:100%">
                <div class="container">
                    <h2 id="lableName">Teacher</h2>
                    <P><button class="button"><a href="adminEnterTeachersDetails.jsp">Enter</a></button></p>
                </div>
            </div>
        </div><div class="column">
            <div class="card">
                <img src="Pictures/black-and-white-school-timetable-theme-1-picture-illustration-GEPP04.jpg" alt="Time Table" style="width:100%;     height: 338px;
">
                <div class="container">
                    <h2 id="lableName">Exam Time Table</h2>
                    <P><button class="button"><a href="adminEnterExamTimeTable.jsp">Enter</a></button></p>
                </div>
            </div>
        </div><div class="column">
            <div class="card">
                <img src="Pictures/search_document-512.png" alt="Views" style="width:100%">
                <div class="container">
                    <h2 id="lableName">Time Table</h2>
                    <P><button class="button"><a href="AdminEnterTimeTable.jsp">Enter</a></button></p>
                </div>
            </div>
        </div>
    </div>
