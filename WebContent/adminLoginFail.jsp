...
alert("Login Failed Check Password and ID");
</script>
</head>
            ...
            <div class="boader2"
                ...
                <div class="boader3"
                    ...
                    <div class="boader4"
                        ...
                        <div class="formMain">
                            <p
								style="    position: relative; top: 23px; left: 39%; font-size: 28px; padding: 0px; margin: 0px;    color: #232f3e; font-family: 'Roboto Condensed', sans-serif;">Admin Login</p>
                            <form action="logAdmin" style="width: 80%;"
								method="post">
                                <div class="container"
									style="    position: relative; left: 203px; top: 27px;">
                                    <img
										src="Pictures/admin-with-cogwheels.svg"
    ...
    <div class="footer" style="    position: relative;top: 150px;">
        <div class="listitemswrapper">
            <ul class="listMain">
                ...
                <li class="listitems"><img
					src="Icons/instagram.png"></li>
