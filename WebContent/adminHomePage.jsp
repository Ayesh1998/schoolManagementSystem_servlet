...
<body>
    ...
    <div class="list">
        <div class="column">
            <div class="card">
                <img src="male-university-graduate-silhouette-with-the-cap.svg" alt="Student" style="width:100%">
                <div class="container">
                    <h2 id="lableName">Student</h2>
                    <P><button class="button"><a href="">Enter</a></button></p>
                </div>
            </div>
        </div><div class="column">
            <div class="card">
                <img src="class.svg" alt="Teacher" style="width:100%">
                <div class="container">
            ...
            <div class="card">
                <img src="black-and-white-school-timetable-theme-1-picture-illustration-GEPP04.jpg" alt="Time Table" style="width:100%;     height: 338px;
">
                <div class="container">
            ...
            <div class="card">
                <img src="search_document-512.png" alt="Views" style="width:100%">
                <div class="container">
                    <h2 id="lableName">Views</h2>
                    <P><button class="button"><a href="">Enter</a></button></p>
                </div>
            </div>
        </div>
