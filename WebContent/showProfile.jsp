...
<body>
    ...
    border: 0px solid white;" >
							...
							<form action="StudentShowProfileServlet" method="post" style="width: 80%;">
								<div class="container">
								<button type="submit" style="margin-left: 81px; width: 112px; border-radius: 5px; font-size: 20px;">View SProfile</button>
								</div>
							</form>
	
							<form action="TeacherShowProfileServlet" style="width: 80%;" method="post">
								<div class="container">
									<button type="submit" style="margin-left: 81px; width: 112px; border-radius: 5px; font-size: 20px;">View TProfile</button>
								</div>
							</form>
