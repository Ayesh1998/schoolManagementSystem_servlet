...
<body>
    ...
    border: 0px solid white;" >
							...
							<form action="teacherShowViewsServlet" method="post" style="width: 80%;">
								<div class="container">
									<button type="submit" style="margin-left: 81px; width: 200px; border-radius: 5px; font-size: 20px;">View Teacher LIst</button>
								</div> 
							</form>
	
	
							<form action="studentShowViewsServlet" method="post" style="width: 80%;">
								<div class="container">
									<button type="submit" style="margin-left: 81px; width: 200px; border-radius: 5px; font-size: 20px;">View Student LIst</button>
								</div> 
							</form>
