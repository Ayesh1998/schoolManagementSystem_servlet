    ...
    border: 0px solid white;" >
						...
						<div class="formMain">
							...
							<form action="StudentDisplayExamTimeTableServlet" style="width: 80%;" method="post">
								<div class="container" style="position: relative; left: 203px; top: 27px;">
									<button type="submit" style="margin-left: 81px; width: 200px; border-radius: 5px; font-size: 20px;">View Sexamtimetable</button>
								</div>
							</form>
						</div>
