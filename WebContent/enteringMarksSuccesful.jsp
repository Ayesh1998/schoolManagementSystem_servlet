...
<body>
    ...
    <div class="formWrapper">
        <form method="post" action="teacherEnterMarksServlet">
            <p>Entering Student's Marks</p>
            <input type="text" name="sid" placeholder="Enter Student's ID" required id="input1">
            <input type="text" name="class" placeholder="Enter Class" required id="input1">
            <input type="text" name="subject" placeholder="Enter Subject Name" id="input1">
            <input type="number" name="marks" placeholder="Enter Marks" id="input1">
