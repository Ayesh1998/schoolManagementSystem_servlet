...
<body>
	...
	<div class="formWrapper">
		...
		<form action="AdminEnterTimeTable" method="post">

			<p>Time Table Data</p>
			
				                                                           
				<input type="text" name="nperiod" placeholder="Enter period" id="input1">
				
				<input type="text" name="nsubject" placeholder="Enter subject" id="input1">
				
				 <input type="text" name="nclass" placeholder="Enter Class" id="input1">
				 
				 <input type="text" name="ntid" placeholder="Enter tid" id="input1">
    ...
    background-color: #243342;color:white;"><a href="ModifyTimeTable.jsp" style="color:white;text-decoration: none;"> Modify Time Table</a></button>
