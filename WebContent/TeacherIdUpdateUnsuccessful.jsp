...
alert("Teacher id Update UnSuccessful");
...
<div id="nav">
	...
	<div class="formWrapper">
		...
		<form action="ModifyTimeTableServlet" method="post">
			<p></p>
			<input type="text" name="class1" placeholder="Enter class" id="input1">
			<input type="text" name="period1" placeholder="Enter period" id="input1">
			...
			<input type="text" name="class2" placeholder="Enter  Class" id="input1">
			<input type="text" name="period2" placeholder="Enter period"id="input1">
			<input type="text" name="subject" placeholder="Enter Subject" id="input1">
			
            <input type="submit" name="button" value="Update_Subject" class="buutonss" style="padding-left: 29px; padding-right: 29px;">
			
			
			<p></p>
			<input type="text" name="class3" placeholder="Enter class" id="input1">
			<input type="text" name="period3" placeholder="Enter period" id="input1">
			<input type="text" name="tid" placeholder="Enter teacher id" id="input1"> 
			
            <input type="submit" name="button" value="Update_Tid" class="buutonss" style="padding-left: 29px; padding-right: 29px;"><br/><br/>
